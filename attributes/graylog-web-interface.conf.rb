...
default['graylog']['web_interface']['graylog-web-interface.conf']['graylog2-server.uris'] = 'http://127.0.0.1:12900'
...
default['graylog']['web_interface']['graylog-web-interface.conf']['application.secret'] = nil
...
default['graylog']['web_interface']['graylog-web-interface.conf']['timezone'] = nil
...
default['graylog']['web_interface']['graylog-web-interface.conf']['field_list_limit'] = 100

# You usually do not want to change this.
default['graylog']['web_interface']['graylog-web-interface.conf']['application.global'] = 'lib.Global'
